    ...
    void Update()
    {
        ...
        for (int group = 0; group < 3; group++)
        {
            if (group == 0)
            {
                ...
                {
                    VibrateWithMainBearing[l].transform.localPosition = va; 
                }
            }
